...
import { buildWhatsAppHref, whatsappQuickHref } from "../utils/whatsapp";
...
export function LandingPage({ onOpenChat }: LandingPageProps) {
  ...
  usePageMeta({
    title: "Synera — Consultoria em Tecnologia",
    description:
      "Consultoria brasileira especializada em Platform Engineering, Kubernetes, DevOps e automação cloud-native."
  });
    ...
    <>
      <section className="hero">
        <div className="hero-inner">
          ...
          <h1>Plataformas cloud-native construídas por quem vive a tecnologia</h1>
          <p className="hero-sub">
            Consultoria especializada em Kubernetes, Platform Engineering e automação. Trabalhamos junto
            ao seu time — do diagnóstico à execução, sem enrolação.
          </p>
          <div className="hero-tech-tags" aria-label="Tecnologias principais">
            {["Kubernetes", "Golang", "ArgoCD", "Backstage", "Temporal.io"].map((t) => (
              <span key={t} className="hero-tech-tag">
                {t}
              </span>
            ))}
          </div>
          ...
          <div className="container">
            <div className="section-header">
              ...
              <p className="section-lead">
                Uma consultoria brasileira fundada em 2010, com mais de uma década de entrega real em
                tecnologia — e participações em eventos internacionais como a KubeCon.
              </p>
            </div>
            ...
            <div className="about-grid">
              <div className="about-text">
                <p>
                  Fundada em 2010, a Synera nasceu da convicção de que tecnologia bem aplicada transforma
                  negócios. Ao longo dos anos, construímos expertise sólida em engenharia de plataforma,
                  automação e DevOps — áreas que evoluem rápido e exigem parceiros que pensam junto com os
                  times.
                </p>
                <p>
                  Atuamos de forma próxima: entendemos os desafios reais antes de propor qualquer solução.
                  Nosso modelo é consultivo e orientado à execução, não à dependência permanente.
                </p>
                <p>
                  O nome Synera une <em>synchronize</em> e <em>era</em> — uma empresa que se atualiza com o
                  tempo, em constante evolução para atender clientes que também estão crescendo.
                </p>
              </div>
        ...
        <section id="servicos" className="section section-alt">
          <div className="container">
            <div className="section-header">
              <h2>Serviços</h2>
              <p className="section-lead">
                Portfólio completo organizado por prioridade. Clique em um serviço para ver detalhes,
              ...
              {serviceGroups.map((group, index) => (
                <section key={group.category} className={`service-group${index === 0 ? " featured" : ""}`}>
                  <div className="service-group-header">
                    ...
                    <a href="#contato" className="group-cta">
                      {group.cta}
                    </a>
                  </div>
                  <div className="cards">
                    {group.items.map((service) => (
                      ...
                      >
                        ...
                        <span className="card-link-hint">Ver página do serviço →</span>
                      </Link>
                    ))}
                  </div>
                </section>
        ...
        <section id="abordagem" className="section approach-section">
          <div className="container">
            <div className="section-header">
              ...
              <p className="section-lead">
                Uma abordagem consultiva e orientada à execução — sem promessas vagas, sem dependência
                permanente.
              </p>
            </div>
        ...
        <section id="treinamento" className="section section-alt">
          <div className="container">
            <div className="section-header">
              <h2>Treinamento</h2>
              <p className="section-lead">
                Capacitações in-company customizadas para levar seu time ao próximo nível em engenharia de
                plataforma e DevOps.
              </p>
            </div>
            <div className="training-layout">
              <div className="training-text">
                <p>
                  Nossos treinamentos in-company são desenhados sob medida para o contexto da sua empresa.
                  Partimos da realidade do time, identificamos lacunas e entregamos um programa prático — com
                  exercícios reais, ambientes de laboratório e mentoria contínua durante e após o
                  treinamento.
                </p>
                <p>
                  Não entregamos slides genéricos. Cada programa é co-construído com o cliente, adaptado às
                  ferramentas e desafios do dia a dia do time.
                </p>
                <a href="#contato" className="btn-primary">
        ...
        <section id="contato" className="section">
          <div className="container">
            <div className="section-header">
              <h2>Contato</h2>
              <p className="section-lead">
                Pronto para transformar sua plataforma? Fale com a Synera e descubra como podemos acelerar
                sua jornada cloud-native.
              </p>
            </div>
            <div className="contact-layout">
              ...
              <div className="contact-sidecards">
                <div className="whatsapp-card">
                  ...
                  <p>
                    Quer resposta rápida? Fale agora com a Synera no WhatsApp e acelere a conversa sobre
                    seu desafio.
                  </p>
                ...
                <div className="chat-card">
                  ...
                  <h3>Fale com AI</h3>
                  <p>
                    Converse com nosso assistente AI sobre desafios de plataforma, Kubernetes, DevOps e
                    modernização. Atendimento imediato, 24 horas.
                  </p>
                  <button type="button" className="chat-card-btn" onClick={onOpenChat} aria-label="Abrir chat com AI">
                    Abrir chat com AI
                  </button>
                </div>
              </div>
